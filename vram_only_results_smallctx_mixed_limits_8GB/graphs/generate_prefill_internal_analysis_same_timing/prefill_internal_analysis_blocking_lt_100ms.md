...
- `Delay from first request in batch (ms)`: Pearson `0.970`, Spearman `0.972`
- `Batch first-token spread (ms)`: Pearson `0.744`, Spearman `0.778`
- `Batch total compute / 8192`: Pearson `0.601`, Spearman `0.659`
- `Batch total computation tokens`: Pearson `0.601`, Spearman `0.659`
- `Computation tokens`: Pearson `0.399`, Spearman `0.511`
