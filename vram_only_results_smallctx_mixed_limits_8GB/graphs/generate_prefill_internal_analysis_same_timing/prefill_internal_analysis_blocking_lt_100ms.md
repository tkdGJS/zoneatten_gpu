...
- `Delay from first request in batch (ms)`: Pearson `0.966`, Spearman `0.972`
- `Batch first-token spread (ms)`: Pearson `0.757`, Spearman `0.799`
- `Batch total compute / 8192`: Pearson `0.581`, Spearman `0.653`
- `Batch total computation tokens`: Pearson `0.581`, Spearman `0.653`
- `Computation tokens`: Pearson `0.351`, Spearman `0.451`
