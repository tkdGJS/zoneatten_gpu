...
- Turn 5: total `5911.5 MiB`, Group1 `4513.0 MiB`, Group2 `1398.5 MiB`
- Turn 6: total `7341.4 MiB`, Group1 `5614.3 MiB`, Group2 `1727.1 MiB`
- Turn 7: total `8746.7 MiB`, Group1 `6700.2 MiB`, Group2 `2046.5 MiB`
- Turn 8: total `10183.3 MiB`, Group1 `7835.5 MiB`, Group2 `2347.8 MiB`
- Turn 9: total `11647.1 MiB`, Group1 `8929.0 MiB`, Group2 `2718.1 MiB`
- Turn 10: total `13037.9 MiB`, Group1 `9992.5 MiB`, Group2 `3045.5 MiB`

## Main Observations

- Mean total input-KV footprint is already high by turn 5 (`5911.5 MiB`) and exceeds the `1024 MiB` reference by turn 6 (`7341.4 MiB`).
- By turn 7 the mean total input-KV footprint grows further to `8746.7 MiB`, and by turn 10 it reaches `13037.9 MiB`.
