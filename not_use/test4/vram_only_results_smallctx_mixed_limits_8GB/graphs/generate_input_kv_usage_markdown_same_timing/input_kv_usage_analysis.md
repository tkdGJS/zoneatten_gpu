...
- Turn 5: total `3666.8 MiB`, Group1 `1880.8 MiB`, Group2 `1786.0 MiB`
- Turn 6: total `4772.8 MiB`, Group1 `2425.3 MiB`, Group2 `2347.5 MiB`
- Turn 7: total `5832.5 MiB`, Group1 `2932.8 MiB`, Group2 `2899.7 MiB`
- Turn 8: total `6960.8 MiB`, Group1 `3503.7 MiB`, Group2 `3457.1 MiB`
- Turn 9: total `8056.6 MiB`, Group1 `4020.2 MiB`, Group2 `4036.4 MiB`
- Turn 10: total `9140.4 MiB`, Group1 `4541.8 MiB`, Group2 `4598.6 MiB`

## Main Observations

- Mean total input-KV footprint is already high by turn 5 (`3666.8 MiB`) and exceeds the `1024 MiB` reference by turn 6 (`4772.8 MiB`).
- By turn 7 the mean total input-KV footprint grows further to `5832.5 MiB`, and by turn 10 it reaches `9140.4 MiB`.
