...
- Group1 mean total TTFT: `14502.94 ms`
- Group2 mean total TTFT: `13513.44 ms`
- Group1 breakdown: blocking `107.68 ms`, prefill `14395.26 ms`, remaining `0.00 ms`
- Group2 breakdown: blocking `124.67 ms`, prefill `13388.76 ms`, remaining `0.00 ms`
- Prefill 차이가 가장 큰 구간은 `Group1` 쪽이며, 두 그룹 간 prefill 평균 차이는 `1006.50 ms`입니다.
- 평균 total TTFT는 `Group1`가 더 크고, 차이는 `989.51 ms`입니다.
