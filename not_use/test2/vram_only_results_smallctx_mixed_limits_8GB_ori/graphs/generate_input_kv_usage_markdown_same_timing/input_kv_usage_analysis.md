...
- Turn 5: total `2887.9 MiB`, Group1 `1785.9 MiB`, Group2 `1102.0 MiB`
- Turn 6: total `3687.1 MiB`, Group1 `2290.7 MiB`, Group2 `1396.4 MiB`
- Turn 7: total `4558.3 MiB`, Group1 `2815.6 MiB`, Group2 `1742.8 MiB`
- Turn 8: total `5499.2 MiB`, Group1 `3394.2 MiB`, Group2 `2105.0 MiB`
- Turn 9: total `6429.3 MiB`, Group1 `3901.1 MiB`, Group2 `2528.2 MiB`
- Turn 10: total `7428.5 MiB`, Group1 `4437.1 MiB`, Group2 `2991.4 MiB`

## Main Observations

- Mean total input-KV footprint is already high by turn 5 (`2887.9 MiB`) and exceeds the `1024 MiB` reference by turn 6 (`3687.1 MiB`).
- By turn 7 the mean total input-KV footprint grows further to `4558.3 MiB`, and by turn 10 it reaches `7428.5 MiB`.
