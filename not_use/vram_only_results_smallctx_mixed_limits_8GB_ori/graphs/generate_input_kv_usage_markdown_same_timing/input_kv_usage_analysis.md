...
- Turn 5: total `3171.8 MiB`, Group1 `1665.8 MiB`, Group2 `1506.0 MiB`
- Turn 6: total `4035.6 MiB`, Group1 `2133.4 MiB`, Group2 `1902.2 MiB`
- Turn 7: total `4886.0 MiB`, Group1 `2579.6 MiB`, Group2 `2306.4 MiB`
- Turn 8: total `0.0 MiB`, Group1 `0.0 MiB`, Group2 `0.0 MiB`
- Turn 9: total `0.0 MiB`, Group1 `0.0 MiB`, Group2 `0.0 MiB`
- Turn 10: total `0.0 MiB`, Group1 `0.0 MiB`, Group2 `0.0 MiB`

## Main Observations

- Mean total input-KV footprint is already high by turn 5 (`3171.8 MiB`) and exceeds the `1024 MiB` reference by turn 6 (`4035.6 MiB`).
- By turn 7 the mean total input-KV footprint grows further to `4886.0 MiB`, and by turn 10 it reaches `0.0 MiB`.
