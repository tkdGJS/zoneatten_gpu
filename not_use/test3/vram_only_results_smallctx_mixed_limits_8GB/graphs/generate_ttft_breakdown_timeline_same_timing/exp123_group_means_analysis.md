...
- Group1 mean total TTFT: `13109.35 ms`
- Group2 mean total TTFT: `13205.09 ms`
- Group1 breakdown: blocking `142.02 ms`, prefill `12967.33 ms`, remaining `0.00 ms`
- Group2 breakdown: blocking `135.16 ms`, prefill `13069.93 ms`, remaining `0.00 ms`
- Prefill 차이가 가장 큰 구간은 `Group2` 쪽이며, 두 그룹 간 prefill 평균 차이는 `102.60 ms`입니다.
- 평균 total TTFT는 `Group2`가 더 크고, 차이는 `95.74 ms`입니다.
