...
- `rank_in_batch` vs `prefill_ms`: Pearson `0.240`, Spearman `0.239`
- `rank_frac` vs `prefill_ms`: Pearson `0.330`, Spearman `0.333`

## Fastest vs Slowest Mean Comparison

- Prefill: fastest `6522.7 ms`, slowest `16872.8 ms`
- Computation tokens: fastest `669.2`, slowest `788.2`
- KV history tokens: fastest `3303.4`, slowest `3691.6`
- Group1 ratio: fastest `0.42`, slowest `0.53`
