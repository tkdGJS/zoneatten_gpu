...
RESULT_DIR="${ROOT_DIR}/vram_only_results_smallctx_mixed_limits_8GB_ori"
LOG_DIR="${ROOT_DIR}/vram_only_logs_smallctx_mixed_limits_8GB_ori"
IO_LOG_DIR="${ROOT_DIR}/vram_only_artifacts_smallctx_mixed_limits_8GB_ori/io_logs"
METRICS_DIR="${ROOT_DIR}/vram_only_artifacts_smallctx_mixed_limits_8GB_ori/request_metrics"
...
MAX_PROMPT_TOKENS="31744"
MAX_TOKENS="1024"
MAX_NUM_SEQS="32"
TARGET_OUTPUT_BUDGET_TOKENS="${MAX_TOKENS}"
SAFETY_MARGIN_TOKENS="64"
SHORT_LIMIT_TOKENS="14336"
LONG_LIMIT_TOKENS="31744"
LONG_TARGET_FINAL_PROMPT_TOKENS="30000"
...
snapshot_experiment_context() {
  ...
  cp "${ROOT_DIR}/run_vram_only_isolation_tenant_sweep_smallctx_mixed_limits_8GB_ori.sh" "${snapshot_dir}/"
