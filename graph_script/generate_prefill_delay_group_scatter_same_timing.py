...
OUT_DIR = ROOT / "analysis_prefill_internal_same_timing"
EXPERIMENTS = [
...
def main():
    ...
    pear = corr(
        [r["delay_from_earliest_first_token_ms"] for r in rows],
        [r["prefill_ms"] for r in rows],
    )
    ax.set_title("Prefill vs earliest first-token delay, blocking time < 100 ms")
    ...
    out_path = OUT_DIR / "prefill_vs_earliest_first_token_delay_by_group_blocking_lt_100ms_32tenants.png"
