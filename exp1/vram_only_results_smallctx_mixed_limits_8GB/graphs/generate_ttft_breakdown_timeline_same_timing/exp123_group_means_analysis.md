...
- Group1 mean total TTFT: `13597.80 ms`
- Group2 mean total TTFT: `11989.92 ms`
- Group1 breakdown: blocking `0.05 ms`, prefill `12271.90 ms`, remaining `1325.86 ms`
- Group2 breakdown: blocking `0.04 ms`, prefill `10449.94 ms`, remaining `1539.94 ms`
- Prefill 차이가 가장 큰 구간은 `Group1` 쪽이며, 두 그룹 간 prefill 평균 차이는 `1821.96 ms`입니다.
- 평균 total TTFT는 `Group1`가 더 크고, 차이는 `1607.88 ms`입니다.

## Tenant 16

- Group1 mean total TTFT: `26139.24 ms`
- Group2 mean total TTFT: `22881.95 ms`
- Group1 breakdown: blocking `12.56 ms`, prefill `24641.52 ms`, remaining `1485.15 ms`
- Group2 breakdown: blocking `154.44 ms`, prefill `21374.81 ms`, remaining `1352.70 ms`
- Prefill 차이가 가장 큰 구간은 `Group1` 쪽이며, 두 그룹 간 prefill 평균 차이는 `3266.71 ms`입니다.
- 평균 total TTFT는 `Group1`가 더 크고, 차이는 `3257.29 ms`입니다.

## Tenant 32

- Group1 mean total TTFT: `100500.51 ms`
- Group2 mean total TTFT: `83655.74 ms`
- Group1 breakdown: blocking `61104.62 ms`, prefill `34819.41 ms`, remaining `4576.49 ms`
- Group2 breakdown: blocking `56407.10 ms`, prefill `23705.46 ms`, remaining `3543.19 ms`
- Prefill 차이가 가장 큰 구간은 `Group1` 쪽이며, 두 그룹 간 prefill 평균 차이는 `11113.95 ms`입니다.
- 평균 total TTFT는 `Group1`가 더 크고, 차이는 `16844.77 ms`입니다.
