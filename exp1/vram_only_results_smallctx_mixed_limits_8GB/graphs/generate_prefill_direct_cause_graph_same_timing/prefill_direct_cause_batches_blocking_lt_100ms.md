...
- `batch_total_computation_tokens` vs `prefill time average (ms)`: `0.619`
- `batch_compute_ratio_8192` vs `batch_p95_prefill_ms`: `0.787`
- `batch_total_resident_kv_mib` vs `prefill time average (ms)`: `0.861`
