...
VENV_DIR="/home/yuhwa2323/tkdgjs"

SOURCE_DATASET_PATH="${ROOT_DIR}/data/ShareGPT_V3_unfiltered_cleaned_split.json"
GENERATED_DATASET_DIR="${ROOT_DIR}/data/generated"
RESULT_DIR="${ROOT_DIR}/vram_only_results_smallctx_mixed_limits"
LOG_DIR="${ROOT_DIR}/vram_only_logs_smallctx_mixed_limits"
IO_LOG_DIR="${ROOT_DIR}/vram_only_artifacts_smallctx_mixed_limits/io_logs"
METRICS_DIR="${ROOT_DIR}/vram_only_artifacts_smallctx_mixed_limits/request_metrics"
...
SHORT_LIMIT_TOKENS="2048"
LONG_LIMIT_TOKENS="8192"
LONG_TARGET_FINAL_PROMPT_TOKENS="7600"
LONG_FINAL_PROMPT_TOLERANCE_TOKENS="400"
PORT="8000"
...
snapshot_experiment_context() {
  ...
  cp "${ROOT_DIR}/run_vram_only_isolation_tenant_sweep_smallctx_mixed_limits.sh" "${snapshot_dir}/"
